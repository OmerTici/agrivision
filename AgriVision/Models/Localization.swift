...
final class LanguageManager: ObservableObject {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "detail.photosEmpty": "No photos yet — add cow photos when enrolling.",
            "detail.photosTapHint": "Tap a photo to view it larger.",
            "detail.photosTapHintEdit": "Tap a photo to view it, then set as profile.",
            "detail.setProfile": "Set as profile",
            ...
            "add.nameTaken": "You already have an animal with this name",
            "add.shuffleName": "Suggest another name",
            "add.tag": "Tag Number",
            ...
            "add.saveEnroll": "Save & Enroll Muzzle",
            "add.saved": "Animal added to herd",
            "add.required": "Required",
            "add.optional": "Optional",
            "add.tag.scan": "Scan ear tag",
            "add.tagTaken": "Another animal already has this tag number",
            "add.muzzle.title": "Muzzle ID",
            "add.muzzle.scan": "Scan muzzle (5 times)",
            "add.muzzle.scanMore": "Scan more",
            "add.muzzle.hint": "Hold steady on the nose — each scan captures automatically.",
            "add.muzzle.optionalHint": "Optional — lets the camera recognize this animal by muzzle. You can add it anytime.",
            "add.muzzlePartialHint": "Finish all 5 muzzle scans, or remove them, to save.",
            "add.profile.title": "Profile Photo",
            "add.profile.add": "Take profile photo",
            "add.profile.captured": "Profile photo added",
            "add.cow.title": "Cow Photos",
            "add.cow.add": "Take cow photo",
            "camera.collect.muzzle": "Muzzle scan",
            "camera.collect.profile": "Profile photo",
            "camera.collect.cow": "Cow photo",
            "camera.collect.done": "Done",
            "enroll.popup.wait": "Enrolling animal…",
            "enroll.popup.waitHint": "Please wait while we register the muzzle.",
            "enroll.popup.success": "Animal enrolled",
            "enroll.popup.failed": "Enrollment failed",
            "enroll.popup.retry": "Try again",
            "enroll.popup.close": "Close",
            "edit.title": "Edit Animal",
            "edit.subtitle": "Update this animal's details",
            "edit.save": "Save Changes",
            "detail.addMuzzle": "Scan muzzle ID (5 scans)",
            "detail.edit": "Edit",
            ...
            "settings.scanFailures": "Failed tag scans",
            "settings.exportScans": "Export scan diagnostics",
            "settings.clearScans": "Clear scan diagnostics",
            ...
            "camera.searching": "Searching your herd…",
            "camera.seekMuzzle": "Waiting for the muzzle…",
            "camera.scanMode.muzzle": "Default",
            "camera.scanMode.earTag": "Ear Tag",
            "camera.scanMode.title": "Camera mode",
            "camera.tagHint": "Point the camera at the ear tag",
            "camera.tagReady": "Tag spotted — hold steady…",
            "camera.goProfile": "Go to animal profile",
            "tag.didYouMean": "Did you mean %@ (%@)?",
            "tag.picker.title": "Tag scanned",
            "tag.picker.use": "Use this number",
            "tag.picker.exists": "This tag already belongs to %@.",
            "tag.notFound.title": "Tag not registered",
            "tag.readFail.toast": "Couldn't read — get a bit closer",
            "camera.tagCloser": "Get closer to the tag",
            "tag.notFound.msg": "No animal in your herd has this tag number.",
            "camera.help": "Help?",
            ...
            "camera.identify.unknown": "Unrecognized animal",
            "camera.identify.unknownPrompt": "Would you like to enroll this animal?",
        ...
        .turkish: [
            ...
            "detail.photosTapHint": "Büyük görmek için bir fotoğrafa dokunun.",
            "detail.photosTapHintEdit": "Görüntüleyip profil yapmak için bir fotoğrafa dokunun.",
            "detail.setProfile": "Profil yap",
            "detail.currentProfile": "Mevcut profil",
            "detail.photosEmpty": "Henüz fotoğraf yok — kayıt sırasında inek fotoğrafı ekleyin.",
            "detail.breed": "Irk",
            "detail.sex": "Cinsiyet",
            "detail.age": "Yaş",
            ...
            "add.nameTaken": "Bu isimde bir hayvanınız zaten var",
            "add.shuffleName": "Başka isim öner",
            ...
            "add.saveEnroll": "Kaydet ve Burun Tanımla",
            "add.saved": "Hayvan sürüye eklendi",
            "add.required": "Zorunlu",
            "add.optional": "İsteğe bağlı",
            "add.tag.scan": "Küpeyi tara",
            "add.tagTaken": "Bu küpe numarası başka bir hayvanda kayıtlı",
            "add.muzzle.title": "Burun Kimliği",
            "add.muzzle.scan": "Burnu tara (5 kez)",
            "add.muzzle.scanMore": "Daha fazla tara",
            "add.muzzle.hint": "Burna sabit tutun — her tarama otomatik alınır.",
            "add.muzzle.optionalHint": "İsteğe bağlı — kameranın bu hayvanı burnundan tanımasını sağlar. Daha sonra da ekleyebilirsiniz.",
            "add.muzzlePartialHint": "Kaydetmek için 5 burun taramasını tamamlayın veya taramaları kaldırın.",
            "add.profile.title": "Profil Fotoğrafı",
            "add.profile.add": "Profil fotoğrafı çek",
            "add.profile.captured": "Profil fotoğrafı eklendi",
            "add.cow.title": "İnek Fotoğrafları",
            "add.cow.add": "İnek fotoğrafı çek",
            "camera.collect.muzzle": "Burun taraması",
            "camera.collect.profile": "Profil fotoğrafı",
            "camera.collect.cow": "İnek fotoğrafı",
            "camera.collect.done": "Bitti",
            "enroll.popup.wait": "Hayvan kaydediliyor…",
            "enroll.popup.waitHint": "Burun kaydedilirken lütfen bekleyin.",
            "enroll.popup.success": "Hayvan kaydedildi",
            "enroll.popup.failed": "Kayıt başarısız",
            "enroll.popup.retry": "Tekrar dene",
            "enroll.popup.close": "Kapat",
            "edit.title": "Hayvanı Düzenle",
            "edit.subtitle": "Bu hayvanın bilgilerini güncelle",
            "edit.save": "Değişiklikleri Kaydet",
            "detail.addMuzzle": "Burun kimliğini tara (5 tarama)",
            "detail.edit": "Düzenle",
            ...
            "settings.scanFailures": "Başarısız küpe taramaları",
            "settings.exportScans": "Tarama kayıtlarını dışa aktar",
            "settings.clearScans": "Tarama kayıtlarını temizle",
            ...
            "camera.searching": "Sürünüzde aranıyor…",
            "camera.seekMuzzle": "Burun bekleniyor…",
            "camera.scanMode.muzzle": "Varsayılan",
            "camera.scanMode.earTag": "Küpe",
            "camera.scanMode.title": "Kamera modu",
            "camera.tagHint": "Kamerayı kulak küpesine doğrultun",
            "camera.tagReady": "Küpe görüldü — sabit tutun…",
            "camera.goProfile": "Hayvan profiline git",
            "tag.didYouMean": "Bu olabilir mi: %@ (%@)?",
            "tag.picker.title": "Küpe okundu",
            "tag.picker.use": "Bu numarayı kullan",
            "tag.picker.exists": "Bu küpe zaten %@ adlı hayvana kayıtlı.",
            "tag.notFound.title": "Küpe kayıtlı değil",
            "tag.readFail.toast": "Okunamadı — biraz yaklaşın",
            "camera.tagCloser": "Küpeye biraz yaklaşın",
            "tag.notFound.msg": "Sürünüzde bu küpe numarasına sahip bir hayvan yok.",
            "camera.help": "Yardım?",
            ...
            "camera.identify.unknown": "Tanınmayan hayvan",
            "camera.identify.unknownPrompt": "Bu hayvanı kaydetmek ister misiniz?",
