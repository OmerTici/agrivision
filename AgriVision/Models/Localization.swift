...
final class LanguageManager: ObservableObject {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "tag.readFail.title": "Couldn't read the tag",
            "tag.readFail.msg": "Get a bit closer and scan again.",
        ...
        .turkish: [
            ...
            "tag.readFail.title": "Küpe okunamadı",
            "tag.readFail.msg": "Biraz yaklaşıp tekrar deneyin.",
