...
final class LanguageManager: ObservableObject {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "add.saveEnroll": "Save & Scan Muzzle",
            "add.saveEnrollHint": "Saving starts the 5 muzzle scans needed to register this animal.",
        ...
        .turkish: [
            ...
            "add.saveEnroll": "Kaydet ve Burun Tara",
            "add.saveEnrollHint": "Kaydetmek, hayvanı kaydetmek için gereken 5 burun taramasını başlatır.",
