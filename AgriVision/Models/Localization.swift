...
final class LanguageManager: ObservableObject {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "add.muzzle.prompt": "5 nose scans run after you tap Save & Scan.",
            "add.muzzle.seeded": "1 of 5 captured",
            "add.muzzle.seededHint": "4 more scans after you save.",
        ...
        .turkish: [
            ...
            "add.muzzle.prompt": "Kaydet ve Tara'ya dokununca 5 burun taraması başlar.",
            "add.muzzle.seeded": "5'ten 1'i alındı",
            "add.muzzle.seededHint": "Kaydettikten sonra 4 tarama daha.",
