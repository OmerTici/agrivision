...
final class LanguageManager: ObservableObject {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "detail.photosEmpty": "No photos yet — add a profile or cow photo when enrolling.",
            "detail.breed": "Breed",
            "detail.sex": "Sex",
            "detail.age": "Age",
        ...
        .turkish: [
            ...
            "detail.photosEmpty": "Henüz fotoğraf yok — kayıt sırasında profil veya inek fotoğrafı ekleyin.",
            "detail.breed": "Irk",
            "detail.sex": "Cinsiyet",
            "detail.age": "Yaş",
