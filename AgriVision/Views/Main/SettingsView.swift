                    ...
                    Button {
                        ...
                        HStack(spacing: 12) {
                            Text(option.rawValue.uppercased())
                                .font(AgriFont.bold(12))
                                .foregroundStyle(AgriColors.purple)
                                .frame(width: 34, height: 34)
                                .background(
                                    RoundedRectangle(cornerRadius: 9, style: .continuous)
                                        .fill(AgriColors.purple.opacity(0.12))
                                )
                            ...
                            if lang.language == option {
                                ...
                                Circle()
                                    .strokeBorder(AgriColors.tabInactive.opacity(0.4), lineWidth: 1.5)
    ...
    private var aboutSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(spacing: 0) {
                ...
                Divider().opacity(0.5)
                LinkRow(icon: "doc.text.fill", tint: AgriColors.tabInactive, title: lang.t("settings.privacy"))
                Divider().opacity(0.5)
                HStack(spacing: 12) {
                    IconBadge(icon: "info.circle.fill", tint: AgriColors.purpleLight)
            ...
            HStack {
                ...
                Button { dismiss() } label: {
                    Image(systemName: "xmark")
                        ...
                        .foregroundStyle(AgriColors.purpleDark)
                        .frame(width: 34, height: 34)
                        .background(Circle().fill(AgriColors.purple.opacity(0.08)))
                }
                .buttonStyle(.plain)
                .accessibilityLabel(lang.t("common.close"))
            }
        ...
        AccountEditSheet(
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                Button(action: sendCode) {
                    HStack(spacing: 8) {
                        if isSendingCode { ProgressView().tint(AgriColors.purple) }
