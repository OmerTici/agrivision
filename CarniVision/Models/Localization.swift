...
final class LanguageManager: ObservableObject {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "camera.fail.noAnimal": "No animal detected. Point at a cow and try again.",
            "camera.fail.notCow": "No cow detected. Point at a cow and try again.",
        ...
        .turkish: [
            ...
            "camera.fail.noAnimal": "Hayvan algılanmadı. Bir ineğe doğrultup tekrar deneyin.",
            "camera.fail.notCow": "İnek algılanmadı. Bir ineğe doğrultup tekrar deneyin.",
